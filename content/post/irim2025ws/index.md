...
The workshop explored **practical challenges and recent advances** in perception, control, and motion planning aimed at bridging the gap between laboratory research and real industrial applications. Particular attention was given to research outcomes and open challenges emerging from the EU-funded projects **[MAGICIAN](https://www.magician-project.eu/)** and **[INVERSE](https://www.inverse-project.org/)**, which address adaptive manufacturing, human-aware robotics, and intelligent automation for next-generation industrial environments.
...
More information about the workshop is available at the official [website](https://idra-lab.github.io/IRIM3D-manufacturing-workshop/).
